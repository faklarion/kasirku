<div class="row">
    <div class="col-md-12 col-xs-8 col-sm-8">
        <form action="<?=base_url('laporan/add_laporan')?>"  method="POST" enctype="multipart/form-data">
				<h3 class="login-head text-center"><i class="fa fa-plus"></i> Add Laporan Harian</h3><br>
                ...
                <div class="form-group">
                    <input class="form-control" name="stok" min='1' type="number" max="99999999" placeholder="Jumlah Stok Terjual" autofocus required>
				</div>
				
				
				<div class="form-group btn-container">
					<button class="btn btn-primary btn-block" type="submit" name="add_laporan"><i class="fa fa-check fa-lg fa-fw"></i>Add</button>
				</div>
